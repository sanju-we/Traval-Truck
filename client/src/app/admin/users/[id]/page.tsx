          ...
          {user.role === 'vendor' && (
            <>
              ...
              <div>
                ...
                <p
                  className={`text-sm font-semibold ${user.isApproved ? 'text-green-600' : 'text-red-600'
                    }`}
                >
            ...
            >
              ...
              <div className="flex justify-center gap-3">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-white flex items-center gap-1 transition ${isBlocked
