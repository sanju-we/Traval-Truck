...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    setIsLoading(true);
    try {
      const data = await RESTAURANT_API_METHODS.login(formData) as ApiResponse;
      ...
      <main className="min-h-screen flex flex-col items-center w-full max-w-md mt-10 px-6">
        ...
        <form className="w-full mt-6 space-y-4">
          ...
          <p className="text-sm text-gray-500 hover:text-gray-700 cursor-pointer">
            <a href="/restaurant/forgetPassword" className="text-purple-600 hover:underline">
              Forgot password?
            </a>
          </p>
        ...
        <p className="mt-6 text-sm text-gray-500">
          ...
          <a href="/restaurant/signup" className="text-purple-600 hover:underline">
            Sign up here
          </a>
        </p>
      </main>
