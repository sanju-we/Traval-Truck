...
import { XCircle, ArrowLeft, Home, RefreshCcw, HelpCircle, Ticket, AlertTriangle, ShieldAlert, Utensils } from "lucide-react";
...
export default function PaymentCancelPage() {
    ...
    useEffect(() => {
        if (planId) {
            (async () => {
                const res = await SHARED_API_METHODS.subscriptionDetails("restaurant", planId) as ApiResponse<Subscription>;
                ...
                >
                    ...
                    <div className="bg-red-600 p-8 sm:p-12 text-center relative overflow-hidden">
                        ...
                        <div className="absolute -top-10 -right-10 opacity-10">
                           <Utensils size={200} className="rotate-12" />
                        </div>
                    ...
                    <div className="p-8 sm:p-12">
                        ...
                        <div className="bg-red-50/50 border border-red-100 rounded-[2rem] p-8 mb-10">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-black text-gray-900 text-lg uppercase tracking-tight">Checkout Halted</h4>
                                    <p className="text-gray-500 text-sm font-medium mt-1 leading-relaxed">
                                        The subscription for <span className="font-bold text-gray-700">{planName || "your restaurant"}</span> hasn't been activated. Your table is still reserved, and you can complete the payment anytime to start receiving orders.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            >
                                <RefreshCcw size={16} /> Retry Activation
                            </Link>
                    ...
                    <div className="bg-gray-50 py-4 text-center">
                        <p className="text-[9px] font-black text-gray-300 uppercase tracking-[0.4em]">Official Restaurant Partner Support</p>
                    </div>
                </motion.div>
            </div>
        </div>
