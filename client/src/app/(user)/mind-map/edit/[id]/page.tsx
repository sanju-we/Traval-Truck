            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                ...
                <button
                  ...
                  className={`w-full bg-gradient-to-r from-emerald-600 to-blue-600 text-white py-4 rounded-xl font-bold transition flex items-center justify-center gap-2 shadow-lg
    ${isGenerating ? 'opacity-70 cursor-not-allowed' : 'hover:from-emerald-700 hover:to-blue-700'}
  `}
                >
                  {isGenerating ? (
                    <>
