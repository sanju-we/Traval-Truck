...
restaurantProfileRouter
    .get('/profile', verifyRestaurantToken, asyncHandler(restaurantProfileController.getRestaurant.bind(restaurantProfileController)))
    .get('/dashboard', verifyRestaurantToken, asyncHandler(restaurantProfileController.getdashboard.bind(restaurantProfileController)))
